    ...
    <header class="site-header">
        <div class="container">
            ...
            <nav class="main-navigation">
                <ul>
                <li <?php if (is_page('news') OR get_post_type() == 'post') echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/news') ?>">News</a></li>
                ...
                <li <?php if (is_page('stories') OR get_post_type() == 'story' OR get_post_type() == 'war') echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/stories') ?>">Stories</a></li>

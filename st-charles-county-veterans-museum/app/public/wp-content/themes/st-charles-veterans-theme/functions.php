...
function pageBanner($args = NULL) {
    ...
    if (!$args['photo']) {
      if (get_field('page_banner_background_image')) {
        ...
        $args['photo'] = get_theme_file_uri('/images/camera/pano-2.jpg');
      }
    }
...
function museum_files(){
    ...
    wp_localize_script('main-js', 'museumData', array(
...
function museum_features() {
    ...
    add_image_size('veteranCard', 150, 150, true);
  ...
  function museum_adjust_queries($query) {
  ...
  add_action('pre_get_posts', 'museum_adjust_queries');

...
<div <?php post_class( 'radiantthemes-shop-box matchHeight style-four' ); ?>>
	<div class="holder">
		<?php if ( $product->is_on_sale() ) { ?>
			<?php echo wp_kses_post( apply_filters( 'woocommerce_sale_flash', '<span class="onsale">' . esc_html__( 'Sale!', 'dizy' ) . '</span>', $post, $product ) ); ?>
		<?php } ?>
		<div class="pic">
			<img src="<?php echo esc_url( get_parent_theme_file_uri( '/assets/images/blank/Blank-Image-100x123.png' ) ); ?>" alt="<?php echo esc_attr__( 'Blank Image', 'dizy' ); ?>" width="100" height="123">
